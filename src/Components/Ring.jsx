function Ring() {
  return (
    <div className="w-full md:w-72 relative flex md:flex-col-reverse gap-5 justify-between items-center hover:shadow-xl transition rounded-lg border border-slate-300 pl-4 md:pl-0 md:py-5">
      <span className="absolute top-0 left-0 p-1 rounded-md bg-yellow-400 font-medium">
        کود: ۱۵۲
      </span>
      <div className="text-right">
        <h3 className="text-sm mt-5 sm:text-lg font-medium">
      ...
      <img
        ...
        className="w-24 md:w-72 md:h-72 h-32 object-cover"
        alt="Product"
      />
    </div>
  );
