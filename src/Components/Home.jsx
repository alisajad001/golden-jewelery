  ...
  return (
    <main className="main-section">
      <section className="max-w-7xl mx-auto h-screen flex flex-col justify-center items-center px-6">
        <h1 className="text-4xl sm:text-7xl text-white text-center">
          Welcome to <br /> <span className="text-yellow-400">Pathan</span>{" "}
          Jewelery
        </h1>
        <p className="text-white font-light max-w-2xl text-center md:text-xl mt-6 leading-7">
